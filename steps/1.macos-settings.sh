...
sudo /usr/sbin/systemsetup -settimezone "America/Argentina/Cordoba" > /dev/null
...
if [[ "$IS_MACBOOK" != "" ]]; then
    sudo pmset -c sleep 0 disksleep 0 displaysleep 10 halfdim 1 powernap 1
    sudo pmset -b sleep 0 disksleep 0 displaysleep 5 halfdim 1 powernap 0
else
...
# @TOCHECK https://github.com/hjuutilainen/dotfiles/blob/master/bin/macos-user-defaults.sh
...
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText -string "Found me? Shoot a mail to jorgemudry@gmail.com to return me. Thanks."
...
# Set Mission Control as a separated space
